...
SUITES=(unit-semver unit-manifest unit-release unit-fetch unit-upgrade e2e-sources e2e-packages e2e-lifecycle e2e-negative e2e-lock-validation e2e-compat)
